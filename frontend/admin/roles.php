...
<head>
    ...
    <title><?= htmlspecialchars($pageTitle) ?> | EPIC EHR Admin</title>
...
<body>
    <header class="admin-header">
        <h1><i class="bi bi-shield-lock"></i> Role & Permission Management</h1>
        <nav class="admin-nav">
            <a href="/index.php"><i class="bi bi-house"></i> Dashboard</a>
            <a href="/admin/" class="active"><i class="bi bi-gear"></i> Admin</a>
            <a href="/admin/users.php"><i class="bi bi-people"></i> Users</a>
            <a href="/admin/audit-log.php"><i class="bi bi-journal-text"></i> Audit Log</a>
        </nav>
    </header>
